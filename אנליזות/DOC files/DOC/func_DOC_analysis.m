function [] = func_DOC_analysis(path_to_file) 
...
disp(['Fraction of times p_lme is non-negative for real data=' num2str(P_real)])
disp(['Fraction of times p_lme is non-negative for null data=' num2str(P_null)])
